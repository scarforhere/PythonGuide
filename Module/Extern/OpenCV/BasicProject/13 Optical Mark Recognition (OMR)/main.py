...
########################################################################
webCamFeed = True
pathImage = r'E:\Python_Code\PythonGuide\Module\Extern\OpenCV\StepIn\CH15\images\test_01.png'
...
ans = [1, 2, 0, 2, 4]
########################################################################
r'E:\Python_Code\PythonGuide\Module\Extern\OpenCV\StepIn\CH15\images\test_01.png'
...
while True:
    ...
    try:
        ...
        if biggestPoints.size != 0 and gradePoints.size != 0:
            ...
            # SPLIT COMPLETE IMG BOX INTO (5,5) BOXES
