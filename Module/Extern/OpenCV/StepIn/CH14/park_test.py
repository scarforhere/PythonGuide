...
if __name__ == '__main__':
    test_images = [plt.imread(path) for path in
                   glob.glob(r'E:\Python_Code\PythonGuide\Module\Extern\OpenCV\StepIn\CH14\test_images\*.jpg')]
    weights_path = r'E:\Python_Code\PythonGuide\Module\Extern\OpenCV\StepIn\CH14\car1.h5'
    video_name = r'E:\Python_Code\PythonGuide\Module\Extern\OpenCV\StepIn\CH14\parking_video.mp4'
    class_dictionary = {}
