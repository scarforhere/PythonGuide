...
if 1:
    # create_fractal aufrufen ohne Zeit zu messen, damit just-in-time Kompilierung durchgeführt
    # wird und später die Zeitmessung nicht verfälscht

    # Beachten Sie den Unterschied in der Grafik, in Abh. von der Ausführung dieses Blocks
